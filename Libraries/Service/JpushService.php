...
class JpushService
{
    ...
    {
        $this->Jpush = new jpush(\Config::get('services.jpush.key'), \Config::get('services.jpush.secret'));
    ...
    public function jpushSend($params)
    {
        ...
        $pusher->setNotificationAlert($params['title']);
        $pusher->androidNotification($params['title'], $notification);
        $pusher->iosNotification($params['title'], $notification);
