...
class Role extends EntrustRole
{
    ...
    public static function roleList()
    {
        ...
        $list = Role::select(['id','name','display_name','description','created_at'])->orderBy("id")->paginate($params['limit'])->toArray()['data'];
        $result['list'] = $list;
        $result['total'] = $total;
        $result['pages'] = $pages;
        return $result;
    ...
    {
        $result = Role::select(['id','name','display_name','description','created_at'])
