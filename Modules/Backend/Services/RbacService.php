...
class RbacService
{
    ...
    public function roleAdd($params){
        /*$validator = \Validator::make($params, [
            'name' => 'required|unique:role|min:6|max:20',
            'role_password' => 'required|min:6',
        ], [
    ...
    public function permissionLeft() {
        ...
        $result['data'] = Permission::permissionLeft(get_admin_id());
        return $result;
    }
