...
use Modules\Order\Services\PayLogService;
...
class OrderServiceProvider extends ServiceProvider
{
    ...
    public function addFacade()
    {
        ...
        $loader->alias('OrderService', \Modules\Order\Facades\OrderFacade::class);
        $loader->alias('BackendOrderService',\Modules\Order\Facades\BackendOrderFacade::class);
        $loader->alias('PayLogService',\Modules\Order\Facades\PayLogFacade::class);
    }
    /**
    ...
    public function register()
    {
        ...
        $this->app->singleton('BackendOrderService',function(){
            return new BackendOrderService();
        });
        $this->app->singleton('PayLogService',function(){
            return new PayLogService();
        });
    }
